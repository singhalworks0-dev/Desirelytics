...
export default function BlogPost() {
  ...
  return (
    <>
      <Seo
        title={post.title}
        description={post.excerpt || "Read full article on Desirelytics blog."}
        path={`/blog/${slug}`}
      />
      <Navbar />
      <main className="relative overflow-hidden bg-[#0a0710] min-h-screen px-4 sm:px-6 lg:px-8 py-20 sm:py-24">
